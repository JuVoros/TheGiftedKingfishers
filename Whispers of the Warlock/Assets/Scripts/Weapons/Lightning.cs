...
{
    public enum LightningAnimationMode
    {
    ...
    public class Lightning : MonoBehaviour
    {
        ...
        public LightningAnimationMode AnimationMode = LightningAnimationMode.PingPong;
        ...
        private void SelectOffsetFromAnimationMode()
        {
            ...
            if (AnimationMode == LightningAnimationMode.None)
            {
                lineRenderer.material.mainTextureOffset = offsets[0];
                return;
            }
            else if (AnimationMode == LightningAnimationMode.PingPong)
            {
            ...
            else if (AnimationMode == LightningAnimationMode.Loop)
            {
                index = animationOffsetIndex++;
                if (animationOffsetIndex >= offsets.Length)
                {
